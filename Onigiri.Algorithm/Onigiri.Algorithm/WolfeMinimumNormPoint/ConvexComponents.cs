...
namespace Onigiri.Algorithm
{
    public abstract class ConvexComponents
    {
        ...
        public bool Add(double[] extremeBase, object data)
        {
        ...
        private bool AddComponent(double[] extremeBase, object data)
        {
        ...
        protected void MultipleyByTransposeAndAddOne(double[] extremeBase, double[] vector)
        {
        ...
        private void AddToComponents(double[] extremeBase, object data)
        {
